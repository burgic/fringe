-- Edinburgh Fringe Show Tracker Database Schema with Reviews
...
CREATE TABLE IF NOT EXISTS shows (
  ...
  review_category TEXT CHECK(review_category IN ('Great', 'Good', 'Ok', 'Wild Cards')), -- Our review categories
  review_notes TEXT, -- Optional notes about why it got this review
...
CREATE INDEX IF NOT EXISTS idx_shows_review_category ON shows(review_category);
