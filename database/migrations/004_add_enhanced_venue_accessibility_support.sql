-- 004_add_enhanced_venue_accessibility_support.sql
-- Migration to add venue and accessibility support to existing database
...
ALTER TABLE shows ADD COLUMN run_time TEXT;
...
ALTER TABLE performances ADD COLUMN accessibility TEXT;
ALTER TABLE performances ADD COLUMN badges TEXT;

-- Create ticket status options table
